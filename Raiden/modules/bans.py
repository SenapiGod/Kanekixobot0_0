...
def ban(update, context):
    ...
    if is_user_ban_protected(chat, user_id, member):
        message.reply_text("That person is a sexy admin, I can't ban")
        return ""
    ...
    if user_id == bot.id:
        message.reply_text("I'm too sexy to be banned.")
        return ""
...
def temp_ban(update, context):
    ...
    if is_user_ban_protected(chat, user_id, member):
        message.reply_text("That person is too sexy to be banned.")
        return ""
...
def unban(update, context):
    ...
    message.reply_text("Done, Unbanned because of their sexiness")
