...
def add_chat(update: Update, context: CallbackContext):
    ...
    if not is_kuki:
        ...
        msg.reply_text("Aqua AI successfully enabled for this chat!")
        message = (
        ...
        return message
    msg.reply_text("Aqua AI is already enabled for this chat!")
    return ""
...
def rem_chat(update: Update, context: CallbackContext):
    ...
    is_kuki = sql.is_kuki(chat.id)
    if not is_kuki:
        msg.reply_text("Aqua AI isn't enabled here in the first place!")
        return ""
    sql.rem_kuki(chat.id)
    msg.reply_text("Aqua AI disabled successfully!")
    message = (
        f"<b>{html.escape(chat.title)}:</b>\n"
        f"AI_DISABLED\n"
        f"<b>Admin:</b> {mention_html(user.id, html.escape(user.first_name))}\n"
...
def list_all_chats(update: Update, context: CallbackContext):
    ...
    text = "<b>Aqua AI -Enabled Chats</b>\n"
    for chat in chats:
        try:
